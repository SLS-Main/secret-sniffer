...
func TestCurrentReportCountsMappings(t *testing.T) {
	...
	if classified != r.Verification.SecretSnifferVerifiablePatterns || r.Verification.UnreviewedPatterns != 308 || r.Verification.ReadOnlyPatterns != 124 || r.Verification.AuthOnlyPatterns != 38 || r.Verification.UnsafePatterns != 97 {
