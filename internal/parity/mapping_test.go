...
func TestCurrentReportCountsMappings(t *testing.T) {
	...
	if classified != r.Verification.SecretSnifferVerifiablePatterns || r.Verification.UnreviewedPatterns != 233 || r.Verification.ReadOnlyPatterns != 164 || r.Verification.AuthOnlyPatterns != 71 || r.Verification.UnsafePatterns != 99 {
