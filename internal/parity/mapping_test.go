...
func TestCurrentReportCountsMappings(t *testing.T) {
	...
	if classified != r.Verification.SecretSnifferVerifiablePatterns || r.Verification.UnreviewedPatterns != 263 || r.Verification.ReadOnlyPatterns != 136 || r.Verification.AuthOnlyPatterns != 70 || r.Verification.UnsafePatterns != 98 {
