...
func TestCurrentReportCountsMappings(t *testing.T) {
	...
	if classified != r.Verification.SecretSnifferVerifiablePatterns || r.Verification.UnreviewedPatterns != 447 || r.Verification.ReadOnlyPatterns != 80 || r.Verification.AuthOnlyPatterns != 14 || r.Verification.UnsafePatterns != 26 {
