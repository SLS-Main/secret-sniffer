...
func TestCurrentReportCountsMappings(t *testing.T) {
	...
	if classified != r.Verification.SecretSnifferVerifiablePatterns || r.Verification.UnreviewedPatterns != 289 || r.Verification.ReadOnlyPatterns != 127 || r.Verification.AuthOnlyPatterns != 54 || r.Verification.UnsafePatterns != 97 {
