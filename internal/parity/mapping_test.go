...
func TestCurrentReportCountsMappings(t *testing.T) {
	...
	if classified != r.Verification.SecretSnifferVerifiablePatterns || r.Verification.UnreviewedPatterns != 512 || r.Verification.ReadOnlyPatterns != 37 || r.Verification.AuthOnlyPatterns != 6 || r.Verification.UnsafePatterns != 12 {
