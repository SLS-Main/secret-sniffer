...
func TestCurrentReportCountsMappings(t *testing.T) {
	...
	if classified != r.Verification.SecretSnifferVerifiablePatterns || r.Verification.UnreviewedPatterns != 225 || r.Verification.ReadOnlyPatterns != 172 || r.Verification.AuthOnlyPatterns != 71 || r.Verification.UnsafePatterns != 99 {
