...
func CurrentMappings() []Mapping {
	return []Mapping{
		...
		mapPlanned("cloud/infrastructure", "terraformcloudpersonaltoken", "Terraform Cloud personal token."),
		...
		mapPlanned("cloud/infrastructure", "netlify", "Netlify token."),
		mapPlanned("cloud/infrastructure", "flyio", "Fly.io token."),
		mapPlanned("cloud/infrastructure", "railwayapp", "Railway token."),
		mapPlanned("cloud/infrastructure", "pulumi", "Pulumi access token."),
		mapPlanned("cloud/infrastructure", "doppler", "Doppler token."),
		mapPlanned("cloud/infrastructure", "tailscale", "Tailscale auth key/API token."),
		mapPlanned("cloud/infrastructure", "ngrok", "ngrok token."),
		...
		mapPlanned("vcs", "azuredevopspersonalaccesstoken", "Azure DevOps PAT."),
		mapPlanned("package-registry", "nugetapikey", "NuGet API key."),
		mapPlanned("package-registry", "rubygems", "RubyGems API key."),
		...
		mapPlanned("developer-tooling", "buildkite", "Buildkite token."),
		...
		mapPlanned("communication", "slackwebhook", "Slack webhook URL."),
		mapPlanned("communication", "discordwebhook", "Discord webhook URL."),
		mapPlanned("communication", "microsoftteamswebhook", "Microsoft Teams webhook URL."),
		mapPlanned("communication", "webex", "Webex credentials."),
		mapPlanned("communication", "webexbot", "Webex bot token."),
		mapPlanned("observability", "datadogtoken", "Datadog app key/API key pair."),
		mapPlanned("observability", "grafana", "Grafana token."),
		mapPlanned("observability", "grafanaserviceaccount", "Grafana service account token."),
		mapPlanned("observability", "sentryorgtoken", "Sentry organization token."),
		mapPlanned("observability", "sentrytoken", "Sentry token."),
		mapPlanned("observability", "honeycomb", "Honeycomb API key."),
		mapPlanned("observability", "splunkobservabilitytoken", "Splunk Observability token."),
		mapPlanned("incident-management", "opsgenie", "Opsgenie API key."),
		...
		mapPlanned("ai-ml", "groq", "Groq API key."),
		mapPlanned("ai-ml", "huggingface", "Hugging Face token."),
		mapPlanned("ai-ml", "replicate", "Replicate token."),
		...
		mapPlanned("payment", "razorpay", "Razorpay credentials."),
		...
		mapPlanned("marketing/crm", "hubspot_apikey", "HubSpot API key."),
		mapPlanned("marketing/crm", "mailchimp", "Mailchimp API key."),
		...
		mapPlanned("email-marketing", "klaviyo", "Klaviyo API key."),
		mapPlanned("sales-scheduling", "calendlyapikey", "Calendly API key."),
		mapPlanned("forms/customer-data", "typeform", "Typeform token."),
		mapPlanned("collaboration/customer-data", "airtablepersonalaccesstoken", "Airtable personal access token."),
		...
		mapPlanned("project-management", "asanapersonalaccesstoken", "Asana personal access token."),
		mapPlanned("project-management/crm", "monday", "Monday.com API token."),
		mapPlanned("project-management", "clickuppersonaltoken", "ClickUp personal token."),
