...
func CurrentMappings() []Mapping {
	return []Mapping{
		...
		mapImplemented("ai-ml", "clarifai", "clarifai-api-key", "Clarifai API key/PAT coverage with provider and key/token label context."),
		mapImplemented("communication", "clicksendsms", "clicksend-api-key", "ClickSend SMS API key coverage with provider and key label context."),
		mapImplemented("ci-cd", "codemagic", "codemagic-api-token", "Codemagic API token coverage with provider and token/key label context."),
		mapImplemented("analytics", "databox", "databox-api-token", "Databox API token coverage with provider and token/key label context."),
		mapImplemented("data-provider", "diffbot", "diffbot-api-token", "Diffbot API token coverage with provider and token/key label context."),
		mapPartial("food/nutrition", "edamam", "edamam-api-key", "Edamam app key covered; app ID/key tuple correlation planned."),
		mapImplemented("crypto", "ethplorer", "ethplorer-api-key", "Ethplorer API key coverage with provider and key label context."),
		mapPartial("ai-ml", "faceplusplus", "faceplusplus-api-key", "Face++ API key covered; key/secret tuple correlation planned."),
		mapImplemented("analytics/dashboard", "geckoboard", "geckoboard-api-key", "Geckoboard API key coverage with provider and key label context."),
		mapImplemented("database/graphql", "hasura", "hasura-admin-secret", "Hasura admin secret coverage with provider and secret label context."),
		mapImplemented("calendar/data", "holidayapi", "holidayapi-key", "Holiday API key coverage with provider and key label context."),
		mapImplemented("document", "html2pdf", "html2pdf-api-key", "HTML2PDF API key coverage with provider and key label context."),
		mapImplemented("geolocation", "ip2location", "ip2location-api-key", "IP2Location API key coverage with provider and key label context."),
		mapImplemented("geolocation", "ipapi", "ipapi-api-key", "ipapi access key coverage with provider and key label context."),
		mapImplemented("geolocation", "ipinfodb", "ipinfodb-api-key", "IPInfoDB API key coverage with provider and key label context."),
		mapImplemented("forms", "jotform", "jotform-api-key", "Jotform API key coverage with provider and key label context."),
		mapImplemented("analytics", "keenio", "keenio-api-key", "Keen.io API key coverage with provider and key label context."),
		mapImplemented("language", "languagelayer", "languagelayer-api-key", "Languagelayer API key coverage with provider and access-key label context."),
		mapImplemented("communication", "linenotify", "linenotify-token", "LINE Notify token coverage with provider and token label context."),
		mapImplemented("data-provider", "linkpreview", "linkpreview-api-key", "LinkPreview API key coverage with provider and key label context."),
		mapImplemented("observability", "loggly", "loggly-token", "Loggly token coverage with provider and token/key label context."),
		mapPartial("analytics", "mixpanel", "mixpanel-api-secret", "Mixpanel API secret covered; project/key tuple correlation planned."),
		mapImplemented("data-generation", "mockaroo", "mockaroo-api-key", "Mockaroo API key coverage with provider and key label context."),
		mapPartial("media/video", "mux", "mux-token-secret", "Mux token secret covered; token ID/secret tuple correlation planned."),
		mapPartial("food/nutrition", "nutritionix", "nutritionix-api-key", "Nutritionix app key covered; app ID/key tuple correlation planned."),
		mapImplemented("finance", "oanda", "oanda-api-token", "OANDA API token coverage with provider and token label context."),
		mapImplemented("logistics", "onfleet", "onfleet-api-key", "Onfleet API key coverage with provider and key label context."),
		mapImplemented("document", "pdflayer", "pdflayer-api-key", "PDFLayer API key coverage with provider and access-key label context."),
		mapImplemented("email-saas", "pepipost", "pepipost-api-key", "Pepipost API key coverage with provider and key label context."),
		mapImplemented("product-management", "pivotaltracker", "pivotaltracker-api-token", "Pivotal Tracker API token coverage with provider and token label context."),
		mapImplemented("media", "pixabay", "pixabay-api-key", "Pixabay API key coverage with provider and key label context."),
		mapImplemented("productivity", "podio", "podio-api-token", "Podio API token coverage with provider and token label context."),
		mapImplemented("messaging", "pubnubpublishkey", "pubnub-publish-key", "PubNub publish key coverage with provider/prefix context."),
		mapImplemented("messaging", "pubnubsubscriptionkey", "pubnub-subscribe-key", "PubNub subscribe key coverage with provider/prefix context."),
		mapImplemented("messaging", "pusherchannelkey", "pusher-channel-key", "Pusher channel key coverage with provider and channel-key label context."),
		mapImplemented("customer-feedback", "qualaroo", "qualaroo-api-key", "Qualaroo API key coverage with provider and key label context."),
		mapImplemented("media/games", "rawg", "rawg-api-key", "RAWG API key coverage with provider and key label context."),
		mapPartial("communication", "ringcentral", "ringcentral-client-secret", "RingCentral client secret covered; client ID/secret tuple correlation planned."),
		mapImplemented("scraping", "scrapeowl", "scrapeowl-api-key", "ScrapeOwl API key coverage with provider and key label context."),
		mapImplemented("scraping", "scrapfly", "scrapfly-api-key", "Scrapfly API key coverage with provider and key label context."),
