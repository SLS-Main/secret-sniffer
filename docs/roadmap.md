...
- Continue mapping the remaining TruffleHog detector-directory identifiers; current tracked parity covers 706 mappings with 169 catalog directories still untracked.
