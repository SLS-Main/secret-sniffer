...
- Continue mapping the remaining TruffleHog detector-directory identifiers; current tracked parity covers 686 mappings with 189 catalog directories still untracked.
