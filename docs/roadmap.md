...
- Continue mapping the remaining TruffleHog detector-directory identifiers; current tracked parity covers 726 mappings with 149 catalog directories still untracked.
