...
- Continue mapping the remaining TruffleHog detector-directory identifiers; current tracked parity covers 645 mappings with 230 catalog directories still untracked.
