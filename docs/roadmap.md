...
- Continue mapping the remaining TruffleHog detector-directory identifiers; current tracked parity covers 666 mappings with 209 catalog directories still untracked.
