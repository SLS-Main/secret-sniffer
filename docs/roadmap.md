...
- Continue mapping the remaining TruffleHog detector-directory identifiers; current tracked parity covers 871 mappings with 4 catalog directories still untracked.
