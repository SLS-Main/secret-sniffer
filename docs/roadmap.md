...
- Continue mapping the remaining TruffleHog detector-directory identifiers; current tracked parity covers 875 mappings with no catalog directories untracked.
