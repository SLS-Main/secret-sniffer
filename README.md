...
This project does not use TruffleHog's discovery algorithm. The scanner is detector-first and is being built toward TruffleHog feature parity through an explicit parity map. Current tracked parity covers 859 mappings, including 804 implemented mappings from the pinned detector catalog snapshot.
